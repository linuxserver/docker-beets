...
<!-- Please read the https://github.com/linuxserver/docker-beets/blob/nightly/.github/CONTRIBUTING.md -->
...
* Update the image: `docker pull lscr.io/linuxserver/beets:nightly`
